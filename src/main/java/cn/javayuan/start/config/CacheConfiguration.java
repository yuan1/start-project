package cn.javayuan.start.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cn.javayuan.start.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cn.javayuan.start.repository.UserRepository.USERS_BY_EMAIL_CACHE);
