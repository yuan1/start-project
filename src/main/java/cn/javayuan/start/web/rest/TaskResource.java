...
import cn.javayuan.start.service.TaskService;
...
/**
 * REST controller for managing {@link cn.javayuan.start.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
     ...
     */
    @GetMapping("/tasks")
    public ResponseEntity<List<TaskDTO>> getAllTasks(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
